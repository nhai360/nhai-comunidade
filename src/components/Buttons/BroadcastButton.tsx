...
const BroadcastButton = ({ }: Props) => {
    ...
    return (
        ...
        <>
            ...
            <button onClick={() => setIsStreaming(!isStreaming)} className={styles.buttonBroadcast}>
                {isStreaming &&
                    <>            <div className={styles.broadcastButtonTextMobile}>
                        ...
                        <span className={styles.endBroadcast} style={{ color: "#F97D7D" }}>Parar Live</span>
                    </div>
                        <div className={styles.broadcastButtonText}>
                            ...
                            <span className={styles.endBroadcast} style={{ color: "#F97D7D" }}>Encerrar transmissão</span>
                        </div>
                    </>
                }
                {!isStreaming &&
