            ...
            <div className={styles.modal}>
                ...
                <div className={styles.modalBody}>
                    <form onSubmit={handleFormSubmit}>
                        ...
                        <div className={styles.question}>
                            <p>
                                Me sinto mais próximo(a) de outros empreendedores e parte de uma comunidade fortalecida
                            </p>
                            <div className={styles.options}>
                                {[1, 2, 3, 4, 5].map((option) => (
                                    <>
                        ...
                        <div className={styles.question}>
                            <p>
                                Passei a ter mais referências (pesquisas, autores e cases) sobre empreendedorismo para
                                continuar sua jornada de conhecimento?
                            </p>
                            <div className={styles.options}>
                                {[1, 2, 3, 4, 5].map((option) => (
                                    <>
